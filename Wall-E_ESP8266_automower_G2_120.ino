//***********************************************************************
//***  Programm-Version BackPort G2 ************************************************
//***********************************************************************

#define PrgVer 1.20  // Backport to Automower G2 UART protocoll
...
String GetHtmlBodyWeb(String logcontent)
{
  ...
  s += "  <div class='content'>";
  s += "    <h1>Alfons</h1>";
  s += "    <p>Husquarna Automower 230ACX</p>";
  ...
  s += "        <tr><td>Status</td><td>%%mower%%</td></tr>";
...
String GetHtmlBodyRoot()
{
  ...
  s += "        <tr><td>Send hex command</td></td><td>http://"+hostName+".local/send?cmd=A0-B1-C2-D3-E4</td></tr>";
  s += "        <tr><td>Send command by name</td><td>http://"+hostName+".local/send?name=HOME</td></tr>";
